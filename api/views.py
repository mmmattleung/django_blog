    ...
    experience = [
        {
            "id":1,
            "time_line": "2010 - 2013",
            "content": ["广东交通职业技术学院", "就读智能交通专业，在校学习道路交通控制技术、GPS电子地图设计、电工电子技术、电路板设计、C语言、SQL Server及网络综合布线等课程。期间考取计算机等级考试二级 C 证书、大学四级英语、CAD 认证工程师、公路收费及监控员（中级）。课余积极参与 PC 服务队的社团活动，致力于为学校师生提供电脑维护及举办一些列电子竞赛活动。"]
        },
        {
            "id": 2,
            "time_line": "2013 - 2017",
            "content": ["弱电系统工程师", "就职于国家机关单位（编制职工），负责弱电系统的建设及维护。工作期间共参与40余项工程建设，各项目金额10至100万不等；负责维护工程造价为2000万的弱电系统设备。"]
        },
        # {
        #     "id": 3,
        #     "time_line": "2017 - 2019",
        #     "content": ["Python 开发者", "负责移动医疗平台产品和项目的接口开发及维护、数据结构的设计、文档的编写（概要设计、详细设计、接口文档）以及管理后台的部分前端开发。"]
        # },
        {
            "id": 3,
            "time_line": "2017 - 2020",
            "content": ["Python 开发者", "曾负责开发旅游公司内部客户关系系统、移动医疗系统、会晤系统、单点登录系统等接口开发、数据库设计、文档编写工作。"]
        },
        {
            "id": 4,
            "time_line": "2019 - Present",
            "content": ["华南理工大学（自考）", "工作中，认识到自身理论水平不足，为进一步全面提升编程能力，业余时间投入到自考本科的学习。"]
        }
    ]
